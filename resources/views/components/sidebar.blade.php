        ...
        <div class="card-body bg-dark box-profile">
            ...
            <ul class="list-group bg-dark mb-3">
                <li class="list-group-item">
                    <a href="" class="d-flex align-items-centen"><i class="fa fa-lock pr-2"></i> <b>Mot de passe</b></a>
                </li>
                <li class="list-group-item">
                    <a href="" class="d-flex align-items-centen"><i class="fa fa-user pr-2"></i> <b>Mon profil</b></a>
                </li>
            </ul>
